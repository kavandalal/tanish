...
// NAMESPACE OBJECT: ./app/api/auth/admin/login/route.ts
...
;// CONCATENATED MODULE: ./app/api/auth/admin/login/route.ts
...
async function POST(req) {
    ...
    try {
        ...
        if (data.username !== process.env.ADMIN_USERNAME || data.password !== process.env.ADMIN_PASSWORD) {
            throw new bad_request/* default */.Z("Username or Password incorrect");
        }
        let userExists = await user/* default */.Z.findOne({
            email: process.env.ADMIN_EMAIL
        });
        if (!userExists) {
            throw new bad_request/* default */.Z("Admin does not exist");
        }
        token = await signJWT({
...
const validatePOST = async (body)=>{
    if (!body.username) throw new bad_request/* default */.Z("Username is required");
    if (!body.password) throw new bad_request/* default */.Z("Password is required");
    return body;
};

;// CONCATENATED MODULE: ./node_modules/.pnpm/next@13.4.19_react-dom@18.2.0_react@18.2.0/node_modules/next/dist/build/webpack/loaders/next-app-loader.js?page=%2Fapi%2Fauth%2Fadmin%2Flogin%2Froute&name=app%2Fapi%2Fauth%2Fadmin%2Flogin%2Froute&pagePath=private-next-app-dir%2Fapi%2Fauth%2Fadmin%2Flogin%2Froute.ts&appDir=E%3A%5CHTML%20CSS%20JS%5Ctanish%5Capp&appPaths=%2Fapi%2Fauth%2Fadmin%2Flogin%2Froute&pageExtensions=tsx&pageExtensions=ts&pageExtensions=jsx&pageExtensions=js&basePath=&assetPrefix=&nextConfigOutput=&preferredRegion=&middlewareConfig=e30%3D!
...
const routeModule = new AppRouteRouteModule({
    ...
    resolvedPagePath: "E:\\HTML CSS JS\\tanish\\app\\api\\auth\\admin\\login\\route.ts",
    nextConfigOutput,
...
const originalPathname = "/api/auth/admin/login/route";
...
var __webpack_exports__ = __webpack_require__.X(0, [6730,8933,1774,9805,2616,2580], () => (__webpack_exec__(52155)));
