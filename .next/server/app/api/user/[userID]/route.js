...
// NAMESPACE OBJECT: ./app/api/user/[userID]/route.ts
...
;// CONCATENATED MODULE: ./app/api/user/[userID]/route.ts
...
async function GET(req, { params }) {
    try {
        ...
        let packet = await user/* default */.Z.findOne({
            _id: userRef
        });
...
const routeModule = new AppRouteRouteModule({
    definition: {
        ...
        page: "/api/user/[userID]/route",
        pathname: "/api/user/[userID]",
        filename: "route",
        bundlePath: "app/api/user/[userID]/route"
    },
    resolvedPagePath: "E:\\HTML CSS JS\\tanish\\app\\api\\user\\[userID]\\route.ts",
    nextConfigOutput,
...
const originalPathname = "/api/user/[userID]/route";
...
var __webpack_exports__ = __webpack_require__.X(0, [6730,8933,1774,2616,8439], () => (__webpack_exec__(52610)));
