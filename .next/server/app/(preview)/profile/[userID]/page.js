...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 20926)), "E:\\HTML CSS JS\\tanish\\app\\(preview)\\profile\\[userID]\\page.tsx"],
...
const pages = ["E:\\HTML CSS JS\\tanish\\app\\(preview)\\profile\\[userID]\\page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(preview)/profile/[userID]/page";
const __next_app__ = {
...
const routeModule = new AppPageRouteModule({
    definition: {
        ...
        page: "/(preview)/profile/[userID]/page",
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 33988))
...
/* harmony import */ var _components_ui_post_explore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8802);
/* harmony import */ var _components_ui_use_toast__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(52270);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(2463);
/* harmony import */ var next_navigation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(28179);
...
function Profile() {
    const { toast } = (0,_components_ui_use_toast__WEBPACK_IMPORTED_MODULE_2__/* .useToast */ .pm)();
    const pathname = (0,next_navigation__WEBPACK_IMPORTED_MODULE_3__.usePathname)();
    const [currentState, setCurrentState] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)("false");
    const [profileData, setProfileData] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)({
        data: null,
        isOwner: false
    });
    const [postList, setPostList] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)();
    ...
    const getProfileData = async ({ profileID })=>{
        try {
            const packet = await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.get(`/api/user/${profileID}`);
            if (!packet?.data?.ok) {
                toast({
                    variant: "destructive",
    ...
    const getPostList = async ({ profileID })=>{
        try {
            const packet = await axios__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .Z.get(`/api/post/user/${profileID}`);
            if (!packet?.data?.ok) {
                toast({
                    variant: "destructive",
                    title: packet?.data?.errors?.[0]?.message
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h5", {
                            ...
                            children: currentState === "true" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        className: "text-blue-500 capitalize",
                                        children: profileData?.data?.name
                                    }),
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                        className: "text-blue-500 capitalize",
                                        children: [
                                            " (",
                                            profileData?.data?.side,
                                            " Side) "
                                        ]
                                    })
                                ]
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    children: [
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            ...
                            children: postList?.map((post)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_5___default()), {
                                    href: `/feed/${post?._id}`,
                                    target: "_self",
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_post_explore__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
                                        data: post,
                                        editable: false
                                    }, post?._id)
                                }))
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\HTML CSS JS\tanish\app\(preview)\profile\[userID]\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [6730,8665,8115,6404,9443,8525,2718,5779,4152,8581,4642,3850,267,8802], () => (__webpack_exec__(84329)));
