...
const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 84518)), "E:\\HTML CSS JS\\tanish\\app\\(preview)\\feed\\[postID]\\page.tsx"],
...
const pages = ["E:\\HTML CSS JS\\tanish\\app\\(preview)\\feed\\[postID]\\page.tsx"];

// @ts-expect-error - replaced by webpack/turbopack loader

const __next_app_require__ = __webpack_require__
const __next_app_load_chunk__ = () => Promise.resolve()
const originalPathname = "/(preview)/feed/[postID]/page";
const __next_app__ = {
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 5727))
...
/* harmony import */ var _components_ui_post_feed__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(22563);
/* harmony import */ var _components_ui_use_toast__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(52270);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(2463);
...
function Feed() {
    ...
    const [callApi, setCallApi] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false);
    const [currentState, setCurrentState] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)("false");
    const [postData, setPostData] = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)();
    ...
    const getPostData = async (postRef)=>{
        try {
            ...
            const result = await axios__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z.get(`/api/post/${postRef}`);
            if (!result?.data?.ok) {
                toast({
                    variant: "destructive",
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                children: postData && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_components_ui_post_feed__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .Z, {
                    data: postData,
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`E:\HTML CSS JS\tanish\app\(preview)\feed\[postID]\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [6730,8665,8115,6404,9443,8525,393,2718,7425,8581,4642,3850,267,1280,2563], () => (__webpack_exec__(21247)));
