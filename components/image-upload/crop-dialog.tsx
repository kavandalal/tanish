...
import { blobToPreview } from '@/lib/client-helper';
			...
			<Dialog open={openModal} onOpenChange={onCloseHere}>
				...
				<DialogContent className='md:max-w-[800px]'>
					<DialogHeader>
						...
						<DialogDescription>
							<div className='gap-4 overflow-hidden grid md:grid-cols-2 grid-cols-1 '>
								{!!imgSrc && (
					...
					<DialogFooter>
						<div className='flex justify-end items-center w-100 flex-col md:flex-row gap-3'>
							<Button
								type='button'
